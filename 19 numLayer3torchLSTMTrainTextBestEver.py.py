...
class LSTMTextCls(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(embedding_num,hidden_num,batch_first=True,bidirectional=LstmBI,num_layers=3)  # 暂且把 rnn 当成是 Linear 看作是一个100 * 200的权重矩阵
        if LstmBI:
    ...
    def forward(self,x,label = None):
        ...
        # num_layers = 1    lstm_output1【batchSize sent_len hidden_num】
        #                   lstm_output2【1 batchSize hidden_num】* 2
        # num_layers = 3    lstm_output1【batchSize sent_len hidden_num】
        #                   lstm_output2【3 batchSize hidden_num】* 2
