...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.att_linear1 = nn.Linear(hiddenNum,hiddenNum)
        self.tanh = nn.Tanh()
        # attention矩阵
        self.att_linear2 = nn.Linear(hiddenNum, 1)
    ...
    def forward(self,batchChiEmb,engHistory):
        ...
        output2 = self.att_linear1(output1)
        attout = self.att_linear2(output2)
        score = torch.softmax(attout,dim=1)
        output1 = output1*score
