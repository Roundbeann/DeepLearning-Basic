...
def get_datas():
    train_datas = load_images("/data2/yuanshou/tmp/handai/mnist/train-images-idx3-ubyte") / 255
    train_label = make_one_hot(load_labels("/data2/yuanshou/tmp/handai/mnist/train-labels-idx1-ubyte"))

    test_datas = load_images("/data2/yuanshou/tmp/handai/mnist/t10k-images-idx3-ubyte") / 255
