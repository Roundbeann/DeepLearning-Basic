...
English = ["cat", "rice", "banana", "pink", "apple", "orange", "peach", "blue", "black", "yellow", "green", "red",
           "white"]
# Chinese = ["粉红色", "橘黄色", "蓝色", "黑色", "黄色", "绿色", "红色", "白色"]
# English = ["pink", "orange", "blue", "black", "yellow", "green", "red", "white"]
...
class transDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        chiIndex = torch.tensor(
            [2] + self.chiIndex[index][:chiMaxLen] + [3] + (chiMaxLen - len(self.chiIndex[index])) * [0])
